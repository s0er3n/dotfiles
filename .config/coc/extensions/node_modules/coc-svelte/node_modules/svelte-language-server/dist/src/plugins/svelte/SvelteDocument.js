...
class TranspiledSvelteDocument {
    ...
    static async create(document, config) {
        ...
        return new TranspiledSvelteDocument(preprocessed.code, preprocessed.map
            ? new documents_1.SourceMapDocumentMapper(await createSourceMapConsumer(preprocessed.map), 
...
class SvelteFragmentMapper {
    ...
    static async createSourceMapper(processed, originalDoc) {
        return processed.reduce(async (parent, processedSingle) => (processedSingle === null || processedSingle === void 0 ? void 0 : processedSingle.map)
            ? new documents_1.SourceMapDocumentMapper(await createSourceMapConsumer(processedSingle.map), originalDoc.uri, await parent)
...
async function createSourceMapConsumer(map) {
