    ...
    async loadConfig(configPath, directory) {
        ...
        try {
            let config = this.disabled
                ? {}
                : (_a = (await this.dynamicImport(url_1.pathToFileURL(configPath)))) === null || _a === void 0 ? void 0 : _a.default;
            if (!config) {
...
exports.configLoader = new ConfigLoader(glob_1.default.sync, fs_1.default, path_1.default, _dynamicImport);
