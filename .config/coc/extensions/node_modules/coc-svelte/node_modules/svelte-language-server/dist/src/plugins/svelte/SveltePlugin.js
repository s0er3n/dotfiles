...
class SveltePlugin {
    ...
    async formatDocument(document, options) {
        ...
        const config = returnObjectIfHasKeys(await prettier.resolveConfig(filePath, { editorconfig: true })) ||
            ...
            this.configManager.get('svelte.format.config'), returnObjectIfHasKeys(this.configManager.getPrettierConfig()) ||
    ...
    async getCompletions(document, position, _, cancellationToken) {
        ...
        return getCompletions_1.getCompletions(svelteDoc, position);
    }
