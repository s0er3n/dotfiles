...
class RenameProviderImpl {
    ...
    async rename(document, position, newName) {
        ...
        convertedRenameLocations = this.checkShortHandBindingLocation(lang, convertedRenameLocations, docs);
    ...
    async getAdditionalLocationsForRenameOfPropInsideOtherComponent(convertedRenameLocations, fragments, lang) {
        ...
        return this.checkShortHandBindingLocation(lang, await this.mapAndFilterRenameLocations(replacementsForProp, fragments), fragments);
    }
    // --------> svelte2tsx?
    ...
    filterWrongRenameLocations(mappedLocations) {
        return utils_1.filterAsync(mappedLocations, async (loc) => {
    ...
    checkShortHandBindingLocation(lang, renameLocations, fragments) {
        const bind = 'bind:';
        return renameLocations.map((location) => {
            ...
            if (!initializer ||
                ...
                attributeName !== ((_b = initializer.expression) === null || _b === void 0 ? void 0 : _b.getText())) {
                return location;
            }
