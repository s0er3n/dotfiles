...
class PluginHost {
    ...
    async getCompletions(textDocument, position, completionContext, cancellationToken) {
        ...
        const completions = (await this.execute('getCompletions', [document, position, completionContext, cancellationToken], ExecuteMode.Collect)).filter((completion) => completion != null);
    ...
    async resolveCompletion(textDocument, completionItem, cancellationToken) {
        ...
        const result = await this.execute('resolveCompletion', [document, completionItem, cancellationToken], ExecuteMode.FirstNonNull);
    ...
    async getDocumentSymbols(textDocument, cancellationToken) {
        ...
        return lodash_1.flatten(await this.execute('getDocumentSymbols', [document, cancellationToken], ExecuteMode.Collect));
    }
    ...
    async getCodeActions(textDocument, range, context, cancellationToken) {
        ...
        return lodash_1.flatten(await this.execute('getCodeActions', [document, range, context, cancellationToken], ExecuteMode.Collect));
    }
